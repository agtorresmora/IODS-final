#  Final Assignment
#Álvaro Germán Torres Mora. December 18, 2017. email: alvaro.torres@helsinki.fi
...
```
#In this regreesion model the Multiple R-squared is the proportion of the variance in the dataset. R-squared will be latter complemented with the residual plots for testing the model.
